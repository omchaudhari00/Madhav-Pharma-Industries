...
urlpatterns = [
    ...
    path('sales-users/<int:sales_user_id>/assign/', AssignCustomersView.as_view(), name='assign_customers'),
    path('sales-users/<int:sales_user_id>/toggle-status/', ToggleSalesUserStatusView.as_view(), name='toggle_sales_user_status'),
