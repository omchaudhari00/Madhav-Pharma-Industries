      ...
      <div className="relative z-10 flex-1 flex flex-col">
        ...
        <div className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10 w-full">
          ...
          <div className="mb-6">
            <button
              onClick={() => navigate('/')}
              className="inline-flex items-center gap-2 text-xs sm:text-sm font-medium text-neutral-800 hover:text-black transition-colors cursor-pointer"
            >
          ...
          {/* ─── Hero Section with Per-Product Cycling Content on Lighter Warm Background ─── */}
          <section
          ...
          <main id="collection-grid" className="w-full scroll-mt-24">
            ...
            <div className="mb-10 text-center">
              ...
              <p className="text-sm sm:text-base text-neutral-300 font-sans-custom max-w-2xl mx-auto leading-relaxed">
