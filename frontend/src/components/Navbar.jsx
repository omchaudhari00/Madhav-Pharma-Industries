...
export const Navbar = () => {
  ...
  return (
    ...
    <header 
      ...
      className={`fixed top-0 left-0 right-0 z-40 w-full h-16 transition-colors duration-300 ${
        isSolid
            ...
            <div className="hidden xl:flex items-center space-x-2 shrink-0">
              ...
              >
                ...
                <span className="relative z-10 flex items-center justify-center space-x-2">
                  <User className="w-3.5 h-3.5 text-[#d4a373] group-hover:text-white transition-colors" />
                ...
                <div className="space-y-2.5">
                  ...
                  >
                    ...
                    <span className="relative z-10 flex items-center space-x-2.5">
                      <User className="w-4 h-4 text-[#d4a373] group-hover:text-white transition-colors" />
                      <span className="font-bold">{user.first_name || user.role}'s Profile</span>
                    </span>
                    <span className="relative z-10 px-2.5 py-1 rounded-full bg-white/10 text-[#d4a373] text-xs font-bold border border-white/20">
                      {user.role} Portal
                    </span>
                  </button>
                  <button
