...
export interface BulkProductDetail {
  id: string;
  name: string;
...
export const BULK_PRODUCTS: Record<string, BulkProductDetail> = {
  "cumin-seed-oil": {
    id: "cumin-seed-oil",
...
export const BulkProductPage: React.FC<{ 
  ...
  const [activeTab, setActiveTab] = useState<"overview" | "specifications" | "applications" | "packaging" | "certifications">("overview");
